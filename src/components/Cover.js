  ...
  return (
    <div className="Cover">
      ...
      <div className="CoverInfo">
        ...
        <p>Golang backend developer with over 3 years experience. Experience with various DevOps terminologies and cloud services. Proven ability in optimizing web functionalities that improve data retrieval and workflow efficiencies.</p>
        <Linkbar />
      </div>
    </div>
  );
